...
graphic_cards = [
    "GeForce RTX 3060", "GeForce RTX 3050", "GeForce RTX 5090", "GeForce RTX 4090", "Radeon RX 580", "GeForce RTX 4060",
    "GeForce RTX 5070", "GeForce RTX 4070", "GeForce GTX 1650", "GeForce RTX 2060", "GeForce RTX 3070",
    "Radeon RX 6600",
    "GeForce GTX 1050 Ti", "GeForce GTX 1060", "GeForce RTX 4070 SUPER", "GeForce GTX 1080 Ti", "Radeon RX 5700 XT",
    "GeForce GTX 1660 SUPER", "GeForce RTX 4060 Ti 8 GB", "Radeon RX 6700 XT", "GeForce RTX 3060 Ti",
    "GeForce RTX 4070 Ti SUPER", "GeForce RTX 3050 8 GB", "Radeon 780M", "Radeon RX 570", "Radeon RX 7800 XT",
    "GeForce RTX 3080", "GeForce GTX 1070", "Radeon RX 7900 XTX", "Radeon RX 7700 XT", "GeForce RTX 4080 SUPER",
    "GeForce RTX 2060 SUPER", "Radeon Vega 8", "Radeon RX 7600", "GeForce RTX 2080 Ti", "GeForce GTX 960",
    "GeForce GTX 1080", "GeForce RTX 3090", "GeForce GTX 1660 Ti", "Radeon RX 6600 XT", "GeForce RTX 4050",
    "GeForce GTX 750 Ti", "GeForce RTX 4070 Ti", "GeForce GTX 970", "Radeon RX 7900 GRE", "Radeon RX 6750 XT",
    "GeForce GTX 1050", "GeForce RTX 4080", "Radeon RX 6650 XT", "Radeon RX 550", "GeForce RTX 3070 Ti"
]
...
technologies = ["NVIDIA DLSS", "NVIDIA Reflex", "NVIDIA STUDIO", "NVIDIA Ray Tracing", "NVIDIA G-Sync",
                "NVIDIA Broadcast", "NVIDIA Game Ready", "NVIDIA Shadow Play", "NVIDIA Ansel", "NVIDIA Freestyle",
                "NVIDIA NVENC", "NVIDIA VR Works", "NVIDIA CUDA"]
tracing = ["есть", "нет"]
dlss = ["есть", "нет"]
...
def gen_gpu_details_data() -> Type[namedtuple]:
    data: Type[Tuple] = namedtuple(
        typename="data",
        field_names=(
            "brand", "card_name", "guarantee_in_years", "gpu_memory_size", "gpu_memory_type", "gpu_memory_width",
            "memory_frequency", "gpu_frequency", "universal_processors_count", "power_connector", "power_block",
            "pci_interface", "technical_process_nanometers", "max_width", "cuda_count", "cooling_system_design",
            "cooling_type", "cooling_count", "technologies", "tracing", "dlss", "direct_x", "opengl", "hdmi_ports",
            "hdmi_port_version", "display_ports", "display_port_version", "monitor_count", "gpu_width", "gpu_height",
            "gpu_thickness", "package_size", "package_weight"
        ),
    )
    return data(
        ...
        package_size=f"0.{random.choice(range(29, 49))}x0.{random.choice(range(10, 17))}x0.{random.choice(range(22, 34))}",
