...
def country_link_data() -> list[dict]:
    products: list[dict] = []
                        ...
                        "properties": [
                            {
                                ...
                                "description": "Система охлаждения графического процессора и видеопамяти. Чем выше производительность графического процессора и памяти, тем больше тепла они выделяют при работе. Система охлаждения позволяет надежно охлаждать видеокарту и отводить тепло из компьютерного корпуса.",
                                "value": "активное",
                                "measure": ""
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "properties": [
                            ...
                            },
                            {
                                ...
                                "description": "Это технология, позволяющая создавать в играх реалистичные освещение, отражения, тени и, как следствие, приближенную к реальности картинку.",
                            ...
                            },
                            {
                                "id": 158136,
                                "name": "Поддержка DLSS",
                                "description": "Сглаживание с алгоритмами глубокого обучения — это технология рендеринга на базе искусственного интеллекта, которая улучшает производительность и качество графики благодаря использованию специализированных тензорных ядер в видеокартах GeForce RTX.",
                        ...
                        "properties": [
                            {
                                "id": 4424,
                                "name": "Разъемов HDMI",
                                "description": "Наличие в видеокарте разъема HDMI, который используется для передачи цифрового видеосигнала. Интерфейс HDMI разработан для передачи видео высокой четкости HDTV.",
                            ...
                            },
                            {
                                ...
                                "description": "Версия разъемов HDMI. В зависимости от версии, разъемы HDMI обладают различными характеристиками. Следует отметить, что изображение в формате 3D поддерживется только разъемами версии 1.4 и выше.",
                            ...
                            },
                            {
                                ...
                                "description": "Наличие в мониторе разъема Display Port, который используется для передачи цифрового видеосигнала. В отличии от разъемов DVI и HDMI, интерфейс Display Port имеет более широкий канал для передачи данных и большую максимальную длину кабеля.",
                            ...
                            },
                            {
                                ...
                                "description": "Версия разъемов Display Port. В зависимости от версии, разъемы Display Port обладают различными характеристиками.",
                        ...
                        "properties": [
                            {
                                ...
                                "description": "Длина видеокарты от планки с видеовыходами, до окончания текстолита или системы охлаждения.",
