...
def net_video_data(limit: int) -> list[dict]:
    products: list[dict] = []
        ...
        products.append(
            {
                ...
                "category": {"id": "5438", "name": "Видеокарты"},
                "materialCisNumber": "30069340",
                "description": f"Видеокарта {gpu_details_data.brand} "
                f"{gpu_details_data.card_name} — устройство с частотой памяти, "
                f"достигающей {gpu_details_data.memory_frequency} МГц, "
                f"подходящее для запуска игр последних лет "
                f"и работы с профессиональным графическим ПО. "
                f"Видеопамять типа {gpu_details_data.gpu_memory_type} "
                        ...
                        },
                        {
                            ...
                            "properties": [
                                ...
                                },
                                {
                                    ...
                                    "nameDescription": "Модуль компьютера, "
                                    "отвечающий за обработку графической "
                                    "составляющей данных.",
                                    "valueDescription": None,
                                    "priority": 8,
                                    "measure": None,
                            ...
                            "properties": [
                                {
                                    ...
                                    "nameDescription": "Чем выше частота, "
                                    "тем быстрее будет передана информация на"
                                    " обработку и тем выше будет производительность устройства.",
                                    "valueDescription": None,
                                    "priority": 9,
                                    "measure": "МГц",
                                    "iconPath": None,
                ...
                "rating": {"star": 5, "count": 1, "percent": 101},
            },
        )
    return products
